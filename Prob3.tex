...
\todo[inline]{Ask how different the definitions should be compared to the ones stated on the Rules}
\todo[inline]{Is it okay to take all the definitions from the same table in the rules? \cite{RulesShipsDNVGLPart6Chap3} (table 3 Definitions). \\ There are a lot more details added further down in the document.}
